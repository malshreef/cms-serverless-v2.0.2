        ...
        <div className={`flex ${isRTL ? 'flex-row-reverse' : 'flex-row'} gap-6`}>
          ...
          <div className="flex-1 min-w-0 flex flex-col justify-between">
            ...
            <div className={`flex items-center ${isRTL ? 'flex-row-reverse' : 'flex-row'} justify-between mt-auto`}>
              ...
              {/* Stats */}
              <div className={`flex items-center ${isRTL ? 'flex-row-reverse' : 'flex-row'} gap-6 text-muted-blue text-sm`}>
                <span className={`flex items-center ${isRTL ? 'flex-row-reverse' : 'flex-row'} gap-1`}>
